...
unsigned long uptime::m_mod_days;
...
{
  return uptime::m_mod_days;
}
unsigned long uptime::getYears()
{
  return uptime::m_years;
}
/***********************************************************/
...
void uptime::calculateUptime()
{
  ...
  if (uptime::m_last_milliseconds > uptime::m_milliseconds) {
    //in case of millis() overflow, store existing passed seconds, minutes, hours, days and years
    ...
    uptime::m_remaining_days    = uptime::m_mod_days;
  }
  ...
  uptime::m_years        = (uptime::m_days         / 365);
  ...
  uptime::m_mod_days         = uptime::m_days         % 365;
}
